  ...
  return (
    <section className="space-y-6 py-32 md:py-48 lg:py-52">
      <div className="container flex max-w-[64rem] flex-col items-center gap-8 text-center">
        {/* capsule */}
        {(props.capsuleText && props.capsuleLink) && <Link href={props.capsuleLink} className="rounded-2xl bg-muted px-4 py-1.5 text-sm font-medium" target="_blank">
          {props.capsuleText}
        </Link>}
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          ...
          {(props.secondaryCtaText && props.secondaryCtaLink) && <Link href={props.secondaryCtaLink} target="_blank" rel="noreferrer" className={cn(buttonVariants({ variant: "outline", size: "lg" }))}>
